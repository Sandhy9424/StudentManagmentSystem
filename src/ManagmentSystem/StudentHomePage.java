...
public class StudentHomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 260, 150, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs=st.executeQuery("SELECT * FROM student WHERE student.roolno='"+RollNo+"';");
        if(!rs.first()){
            JOptionPane.showMessageDialog(null, "Roll no. Not Found");
        }
        else{
          studentDetails frame=new studentDetails(RollNo);
          frame.setVisible(true);
          frame.setLocationRelativeTo(null);
        }
        }
